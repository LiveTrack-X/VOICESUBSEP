...
Scope of the **published 0.3.1 Windows preview**, reviewed on 2026-09-25. Local installation and public release verification are recorded in the [0.3.1 release record](releases/v0.3.1.md). Implemented means code and a usable path exist, not proof of device quality, paid-provider access or semantic accuracy. Earlier [0.3.0](releases/v0.3.0.md), [0.2.1](releases/v0.2.1.md) and [0.2.0](releases/v0.2.0.md) records remain historical evidence.

2026-09-25 기준 **공개된 0.3.1 Windows 프리뷰**를 요청과 대조했습니다. 로컬 설치·공개 검증은 [0.3.1 릴리즈 기록](releases/v0.3.1.md)에 있습니다. `구현`은 코드와 사용 경로가 있다는 뜻이며 장치 품질·유료 접근·인식 정확도 보증이 아닙니다. [0.3.0](releases/v0.3.0.md) 등 이전 기록은 당시 증거로 보존합니다.
...
| Public repo, bilingual docs, small EXE / 공개·한영 문서·작은 EXE | 0.3.1 published / 0.3.1 공개 | Public no-login setup, SHA256-pinned download/resume/assembly; ten release assets, anonymous helper/metadata verification and local installation recorded separately / 로그인 없는 설치기·체크섬·이어받기·조립, 릴리즈 파일 10개·익명 도우미/명세 확인·로컬 설치 범위 별도 기록 |
